--- pxr/base/arch/fileSystem.cpp.orig	2026-02-23 22:54:59 UTC
...
+#endif
 ...
 #endif
@@ -147,7 +155,7 @@ ArchStatIsWritable(const ArchStatType *st)
 bool
...
@@ -185,7 +193,7 @@ ArchGetModificationTime(const ArchStatType& st)
 double
...
@@ -437,7 +445,7 @@ ArchGetAccessTime(const struct stat& st)
 double
...
@@ -452,7 +460,7 @@ ArchGetStatusChangeTime(const struct stat& st)
 double
...
@@ -483,7 +491,7 @@ ArchGetFileLength(FILE *file)
     if (!file)
         return -1;
 #if defined (ARCH_OS_LINUX) || defined (ARCH_OS_DARWIN) || \
-    defined(ARCH_OS_WASM_VM)
...
@@ -498,7 +506,7 @@ ArchGetFileLength(const char* fileName)
...
@@ -561,7 +569,49 @@ ArchGetFileName(FILE *file)
...
+    return path;                                     
 ...
 #endif
@@ -925,6 +975,9 @@ ArchQueryMappedMemoryResidency(
     int ret = mincore(
