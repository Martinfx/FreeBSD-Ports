--- chromium/third_party/ffmpeg/chromium/config/Chrome/freebsd/x64/config.asm.orig	2022-06-07 19:20:06 UTC
+++ chromium/third_party/ffmpeg/chromium/config/Chrome/freebsd/x64/config.asm
@@ -0,0 +1,720 @@
