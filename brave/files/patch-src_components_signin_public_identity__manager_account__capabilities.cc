--- src/components/signin/public/identity_manager/account_capabilities.cc.orig	2026-08-12 09:02:10 UTC
+++ src/components/signin/public/identity_manager/account_capabilities.cc
