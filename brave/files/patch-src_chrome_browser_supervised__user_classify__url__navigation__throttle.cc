--- src/chrome/browser/supervised_user/classify_url_navigation_throttle.cc.orig	2026-03-13 06:02:14 UTC
+++ src/chrome/browser/supervised_user/classify_url_navigation_throttle.cc
@@ -42,7 +42,7 @@
