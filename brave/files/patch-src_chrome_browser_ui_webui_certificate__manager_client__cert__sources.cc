--- src/chrome/browser/ui/webui/certificate_manager/client_cert_sources.cc.orig	2026-03-13 06:02:14 UTC
+++ src/chrome/browser/ui/webui/certificate_manager/client_cert_sources.cc
@@ -55,7 +55,7 @@
