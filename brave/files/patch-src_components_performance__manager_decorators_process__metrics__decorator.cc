--- src/components/performance_manager/decorators/process_metrics_decorator.cc.orig	2026-08-12 09:02:10 UTC
+++ src/components/performance_manager/decorators/process_metrics_decorator.cc
