--- src/chrome/browser/policy/developer_tools_policy_checker_factory.cc.orig	2026-08-12 09:02:10 UTC
+++ src/chrome/browser/policy/developer_tools_policy_checker_factory.cc
