--- src/chrome/browser/web_applications/os_integration/web_app_shortcut.cc.orig	2026-07-01 06:24:19 UTC
+++ src/chrome/browser/web_applications/os_integration/web_app_shortcut.cc
@@ -66,7 +66,7 @@ namespace {
