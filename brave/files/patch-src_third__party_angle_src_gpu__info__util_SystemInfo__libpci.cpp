--- src/third_party/angle/src/gpu_info_util/SystemInfo_libpci.cpp.orig	2026-02-11 09:05:39 UTC
+++ src/third_party/angle/src/gpu_info_util/SystemInfo_libpci.cpp
@@ -13,6 +13,11 @@
 #include <unistd.h>
 #include <fstream>
