--- src/chrome/browser/web_applications/os_integration/shortcut_sub_manager.cc.orig	2026-01-14 08:33:23 UTC
+++ src/chrome/browser/web_applications/os_integration/shortcut_sub_manager.cc
