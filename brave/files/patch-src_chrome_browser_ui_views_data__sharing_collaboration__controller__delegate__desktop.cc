--- src/chrome/browser/ui/views/data_sharing/collaboration_controller_delegate_desktop.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/browser/ui/views/data_sharing/collaboration_controller_delegate_desktop.cc
