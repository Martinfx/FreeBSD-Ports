--- src/chrome/browser/web_applications/test/os_integration_test_override_impl.cc.orig	2026-08-12 09:02:10 UTC
+++ src/chrome/browser/web_applications/test/os_integration_test_override_impl.cc
@@ -49,7 +49,7 @@
