--- src/chrome/browser/ui/views/profiles/signin_view_controller_delegate_views.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/browser/ui/views/profiles/signin_view_controller_delegate_views.cc
@@ -62,14 +62,14 @@
