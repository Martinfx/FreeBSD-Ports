--- src/components/enterprise/connectors/core/realtime_reporting_client_base.cc.orig	2026-08-12 09:02:10 UTC
+++ src/components/enterprise/connectors/core/realtime_reporting_client_base.cc
