--- src/components/startup_metric_utils/browser/startup_metric_utils.cc.orig	2026-08-31 10:59:09 UTC
+++ src/components/startup_metric_utils/browser/startup_metric_utils.cc
@@ -36,11 +36,11 @@
