--- src/components/performance_manager/resource_attribution/memory_measurement_delegate.cc.orig	2026-02-11 09:05:39 UTC
+++ src/components/performance_manager/resource_attribution/memory_measurement_delegate.cc
