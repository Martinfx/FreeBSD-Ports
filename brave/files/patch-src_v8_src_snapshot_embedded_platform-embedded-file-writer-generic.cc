--- src/v8/src/snapshot/embedded/platform-embedded-file-writer-generic.cc.orig	2026-01-14 08:33:23 UTC
+++ src/v8/src/snapshot/embedded/platform-embedded-file-writer-generic.cc
@@ -9,6 +9,10 @@
