--- src/remoting/host/create_desktop_interaction_strategy_factory.cc.orig	2026-01-14 08:33:23 UTC
+++ src/remoting/host/create_desktop_interaction_strategy_factory.cc
@@ -12,7 +12,7 @@
