--- src/components/paint_preview/player/player_compositor_delegate.cc.orig	2026-08-12 09:02:10 UTC
+++ src/components/paint_preview/player/player_compositor_delegate.cc
