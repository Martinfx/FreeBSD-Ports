--- src/media/video/renderable_mappable_shared_image_video_frame_pool.cc.orig	2026-05-07 17:02:56 UTC
+++ src/media/video/renderable_mappable_shared_image_video_frame_pool.cc
