--- src/chrome/browser/ui/views/passwords/password_bubble_view_base.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/browser/ui/views/passwords/password_bubble_view_base.cc
@@ -36,7 +36,7 @@
