--- src/components/enterprise/browser/reporting/chrome_profile_request_generator.cc.orig	2026-08-31 10:59:09 UTC
+++ src/components/enterprise/browser/reporting/chrome_profile_request_generator.cc
