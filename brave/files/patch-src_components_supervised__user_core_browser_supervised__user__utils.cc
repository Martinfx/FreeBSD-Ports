--- src/components/supervised_user/core/browser/supervised_user_utils.cc.orig	2026-06-04 10:12:25 UTC
+++ src/components/supervised_user/core/browser/supervised_user_utils.cc
