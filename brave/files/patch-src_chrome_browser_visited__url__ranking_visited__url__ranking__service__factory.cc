--- src/chrome/browser/visited_url_ranking/visited_url_ranking_service_factory.cc.orig	2025-05-05 10:57:53 UTC
+++ src/chrome/browser/visited_url_ranking/visited_url_ranking_service_factory.cc
@@ -45,7 +45,7 @@
