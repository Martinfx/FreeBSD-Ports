--- src/chrome/browser/ui/webui/password_manager/notification_cards_handler.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/browser/ui/webui/password_manager/notification_cards_handler.cc
@@ -30,7 +30,7 @@
 #endif
