--- src/chrome/browser/ui/webui/user_education_internals/user_education_internals_page_handler_impl.cc.orig	2026-08-12 09:02:10 UTC
+++ src/chrome/browser/ui/webui/user_education_internals/user_education_internals_page_handler_impl.cc
@@ -50,7 +50,7 @@
