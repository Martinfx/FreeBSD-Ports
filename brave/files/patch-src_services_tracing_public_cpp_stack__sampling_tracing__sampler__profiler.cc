--- src/services/tracing/public/cpp/stack_sampling/tracing_sampler_profiler.cc.orig	2026-07-01 06:24:19 UTC
+++ src/services/tracing/public/cpp/stack_sampling/tracing_sampler_profiler.cc
@@ -42,7 +42,7 @@
