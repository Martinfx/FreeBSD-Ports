--- src/components/password_manager/core/browser/password_manual_fallback_flow.cc.orig	2026-08-31 10:59:09 UTC
+++ src/components/password_manager/core/browser/password_manual_fallback_flow.cc
...
@@ -350,7 +350,7 @@ void PasswordManualFallbackFlow::DidAcceptSuggestion(
     }
...
@@ -501,7 +501,7 @@ void PasswordManualFallbackFlow::EnsureCrossDomainPass
