--- src/ui/ozone/platform/wayland/host/wayland_data_drag_controller.cc.orig	2026-05-07 17:02:56 UTC
+++ src/ui/ozone/platform/wayland/host/wayland_data_drag_controller.cc
@@ -48,7 +48,7 @@
