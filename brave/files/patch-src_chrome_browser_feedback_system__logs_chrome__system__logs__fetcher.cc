--- src/chrome/browser/feedback/system_logs/chrome_system_logs_fetcher.cc.orig	2026-04-09 06:05:42 UTC
+++ src/chrome/browser/feedback/system_logs/chrome_system_logs_fetcher.cc
@@ -46,7 +46,7 @@
