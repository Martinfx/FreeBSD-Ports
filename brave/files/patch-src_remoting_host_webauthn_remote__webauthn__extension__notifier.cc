--- src/remoting/host/webauthn/remote_webauthn_extension_notifier.cc.orig	2026-05-07 17:02:56 UTC
+++ src/remoting/host/webauthn/remote_webauthn_extension_notifier.cc
@@ -27,7 +27,7 @@
