--- src/components/startup_metric_utils/browser/startup_metric_utils.h.orig	2026-08-31 10:59:09 UTC
+++ src/components/startup_metric_utils/browser/startup_metric_utils.h
