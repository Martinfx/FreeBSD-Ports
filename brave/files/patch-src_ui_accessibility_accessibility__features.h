--- src/ui/accessibility/accessibility_features.h.orig	2026-08-31 10:59:09 UTC
+++ src/ui/accessibility/accessibility_features.h
...
@@ -420,7 +420,7 @@ AX_BASE_EXPORT BASE_DECLARE_FEATURE(kMacAccessibilityT
