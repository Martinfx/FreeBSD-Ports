--- src/chrome/browser/enterprise/signals/signals_aggregator_factory.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/browser/enterprise/signals/signals_aggregator_factory.cc
@@ -63,7 +63,7 @@
