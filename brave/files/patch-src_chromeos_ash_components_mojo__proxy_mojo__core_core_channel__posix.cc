--- src/chromeos/ash/components/mojo_proxy/mojo_core/core/channel_posix.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chromeos/ash/components/mojo_proxy/mojo_core/core/channel_posix.cc
@@ -28,7 +28,7 @@
