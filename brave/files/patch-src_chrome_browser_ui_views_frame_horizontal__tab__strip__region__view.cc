--- src/chrome/browser/ui/views/frame/horizontal_tab_strip_region_view.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/browser/ui/views/frame/horizontal_tab_strip_region_view.cc
