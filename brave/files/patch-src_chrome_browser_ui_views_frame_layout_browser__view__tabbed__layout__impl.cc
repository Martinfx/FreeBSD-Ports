--- src/chrome/browser/ui/views/frame/layout/browser_view_tabbed_layout_impl.cc.orig	2026-08-12 09:02:10 UTC
+++ src/chrome/browser/ui/views/frame/layout/browser_view_tabbed_layout_impl.cc
