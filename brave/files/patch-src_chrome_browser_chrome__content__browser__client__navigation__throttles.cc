--- src/chrome/browser/chrome_content_browser_client_navigation_throttles.cc.orig	2026-08-12 09:02:10 UTC
+++ src/chrome/browser/chrome_content_browser_client_navigation_throttles.cc
@@ -142,7 +142,7 @@
