--- src/media/gpu/sandbox/hardware_video_encoding_sandbox_hook_linux.h.orig	2023-04-28 17:01:32 UTC
+++ src/media/gpu/sandbox/hardware_video_encoding_sandbox_hook_linux.h
@@ -5,7 +5,13 @@
