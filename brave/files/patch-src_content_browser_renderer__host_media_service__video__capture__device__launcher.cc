--- src/content/browser/renderer_host/media/service_video_capture_device_launcher.cc.orig	2025-10-30 15:44:36 UTC
+++ src/content/browser/renderer_host/media/service_video_capture_device_launcher.cc
@@ -24,7 +24,7 @@
