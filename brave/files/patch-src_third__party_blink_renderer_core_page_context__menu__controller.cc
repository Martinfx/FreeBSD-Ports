--- src/third_party/blink/renderer/core/page/context_menu_controller.cc.orig	2026-08-31 10:59:09 UTC
+++ src/third_party/blink/renderer/core/page/context_menu_controller.cc
@@ -680,7 +680,7 @@ bool ContextMenuController::ShowContextMenu(
