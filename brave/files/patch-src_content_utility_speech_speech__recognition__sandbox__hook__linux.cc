--- src/content/utility/speech/speech_recognition_sandbox_hook_linux.cc.orig	2026-06-04 10:12:25 UTC
+++ src/content/utility/speech/speech_recognition_sandbox_hook_linux.cc
@@ -12,11 +12,14 @@
