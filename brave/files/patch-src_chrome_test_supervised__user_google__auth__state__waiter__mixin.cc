--- src/chrome/test/supervised_user/google_auth_state_waiter_mixin.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/test/supervised_user/google_auth_state_waiter_mixin.cc
