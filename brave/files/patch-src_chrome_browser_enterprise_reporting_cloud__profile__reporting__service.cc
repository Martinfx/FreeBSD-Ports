--- src/chrome/browser/enterprise/reporting/cloud_profile_reporting_service.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/browser/enterprise/reporting/cloud_profile_reporting_service.cc
@@ -36,7 +36,7 @@
