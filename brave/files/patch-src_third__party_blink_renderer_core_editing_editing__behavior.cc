--- src/third_party/blink/renderer/core/editing/editing_behavior.cc.orig	2026-06-04 10:12:25 UTC
+++ src/third_party/blink/renderer/core/editing/editing_behavior.cc
