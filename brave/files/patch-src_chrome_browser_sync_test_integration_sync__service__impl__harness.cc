--- src/chrome/browser/sync/test/integration/sync_service_impl_harness.cc.orig	2026-05-07 17:02:56 UTC
+++ src/chrome/browser/sync/test/integration/sync_service_impl_harness.cc
