--- src/chrome/browser/feedback/system_logs/about_system_logs_fetcher.cc.orig	2025-07-02 06:08:04 UTC
+++ src/chrome/browser/feedback/system_logs/about_system_logs_fetcher.cc
@@ -38,7 +38,7 @@
