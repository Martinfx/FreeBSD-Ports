--- src/third_party/blink/renderer/platform/fonts/skia/font_cache_skia.cc.orig	2026-08-12 09:02:10 UTC
+++ src/third_party/blink/renderer/platform/fonts/skia/font_cache_skia.cc
