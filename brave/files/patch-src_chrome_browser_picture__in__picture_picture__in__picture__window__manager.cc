--- src/chrome/browser/picture_in_picture/picture_in_picture_window_manager.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/browser/picture_in_picture/picture_in_picture_window_manager.cc
@@ -23,7 +23,7 @@
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 #include "components/webapps/isolated_web_apps/scheme.h"
         ...
         // BUILDFLAG(IS_CHROMEOS)
@@ -597,7 +597,7 @@ void PictureInPictureWindowManager::SetWindowParams(Na
