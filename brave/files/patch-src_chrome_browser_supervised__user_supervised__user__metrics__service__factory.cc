--- src/chrome/browser/supervised_user/supervised_user_metrics_service_factory.cc.orig	2026-02-11 09:05:39 UTC
+++ src/chrome/browser/supervised_user/supervised_user_metrics_service_factory.cc
@@ -19,7 +19,7 @@
