--- src/chrome/common/extensions/permissions/chrome_permission_message_rules.cc.orig	2026-02-11 09:05:39 UTC
+++ src/chrome/common/extensions/permissions/chrome_permission_message_rules.cc
