--- src/remoting/host/webauthn/remote_webauthn_caller_security_utils.cc.orig	2026-08-31 10:59:09 UTC
+++ src/remoting/host/webauthn/remote_webauthn_caller_security_utils.cc
@@ -13,11 +13,11 @@
