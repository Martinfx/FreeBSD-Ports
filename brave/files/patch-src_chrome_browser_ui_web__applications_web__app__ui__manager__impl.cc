--- src/chrome/browser/ui/web_applications/web_app_ui_manager_impl.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/browser/ui/web_applications/web_app_ui_manager_impl.cc
