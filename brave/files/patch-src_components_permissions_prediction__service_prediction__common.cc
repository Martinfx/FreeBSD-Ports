--- src/components/permissions/prediction_service/prediction_common.cc.orig	2025-07-02 06:08:04 UTC
+++ src/components/permissions/prediction_service/prediction_common.cc
