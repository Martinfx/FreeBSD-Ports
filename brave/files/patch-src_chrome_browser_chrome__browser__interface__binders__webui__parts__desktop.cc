--- src/chrome/browser/chrome_browser_interface_binders_webui_parts_desktop.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/browser/chrome_browser_interface_binders_webui_parts_desktop.cc
@@ -143,7 +143,7 @@
