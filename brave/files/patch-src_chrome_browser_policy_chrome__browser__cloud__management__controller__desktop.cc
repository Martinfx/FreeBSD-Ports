--- src/chrome/browser/policy/chrome_browser_cloud_management_controller_desktop.cc.orig	2026-08-12 09:02:10 UTC
+++ src/chrome/browser/policy/chrome_browser_cloud_management_controller_desktop.cc
@@ -59,7 +59,7 @@
