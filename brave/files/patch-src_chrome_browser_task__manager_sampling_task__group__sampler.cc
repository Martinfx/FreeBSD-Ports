--- src/chrome/browser/task_manager/sampling/task_group_sampler.cc.orig	2025-03-05 08:14:56 UTC
+++ src/chrome/browser/task_manager/sampling/task_group_sampler.cc
