--- src/chrome/browser/component_updater/iwa_key_distribution_component_installer.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/browser/component_updater/iwa_key_distribution_component_installer.cc
