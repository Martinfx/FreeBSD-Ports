--- src/third_party/libphonenumber/src/cpp/src/phonenumbers/base/synchronization/lock.h.orig	2026-06-04 10:12:25 UTC
+++ src/third_party/libphonenumber/src/cpp/src/phonenumbers/base/synchronization/lock.h
@@ -22,7 +22,7 @@
