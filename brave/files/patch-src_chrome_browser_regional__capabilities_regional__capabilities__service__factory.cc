--- src/chrome/browser/regional_capabilities/regional_capabilities_service_factory.cc.orig	2026-04-09 06:05:42 UTC
+++ src/chrome/browser/regional_capabilities/regional_capabilities_service_factory.cc
@@ -21,7 +21,7 @@
