--- src/chrome/browser/ui/webui/management/management_ui_constants.cc.orig	2026-05-07 17:02:56 UTC
+++ src/chrome/browser/ui/webui/management/management_ui_constants.cc
