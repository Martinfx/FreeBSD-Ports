--- src/components/autofill/core/browser/payments/amount_extraction_manager.cc.orig	2026-08-31 10:59:09 UTC
+++ src/components/autofill/core/browser/payments/amount_extraction_manager.cc
