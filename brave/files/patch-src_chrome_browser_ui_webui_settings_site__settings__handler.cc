--- src/chrome/browser/ui/webui/settings/site_settings_handler.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/browser/ui/webui/settings/site_settings_handler.cc
@@ -128,7 +128,7 @@
