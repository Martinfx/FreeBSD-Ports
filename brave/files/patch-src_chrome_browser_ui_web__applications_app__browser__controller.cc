--- src/chrome/browser/ui/web_applications/app_browser_controller.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/browser/ui/web_applications/app_browser_controller.cc
