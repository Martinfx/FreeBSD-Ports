--- src/net/socket/udp_socket_unittest.cc.orig	2026-08-31 10:59:09 UTC
+++ src/net/socket/udp_socket_unittest.cc
...
@@ -832,7 +832,7 @@ TEST_F(UDPSocketTest, ClientSetDoNotFragment) {
     EXPECT_THAT(rv, IsOk());
...
+#if BUILDFLAG(IS_IOS) || BUILDFLAG(IS_FUCHSIA) || BUILDFLAG(IS_BSD)
 ...
 #else
@@ -854,7 +854,7 @@ TEST_F(UDPSocketTest, ServerSetDoNotFragment) {
     EXPECT_THAT(rv, IsOk());
...
@@ -971,7 +971,7 @@ TEST_F(UDPSocketTest, MAYBE_SharedMulticastAddress) {
