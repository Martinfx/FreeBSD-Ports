--- src/chrome/browser/safe_browsing/security_settings_bundle_pref_change_handler.h.orig	2026-06-04 10:12:25 UTC
+++ src/chrome/browser/safe_browsing/security_settings_bundle_pref_change_handler.h
@@ -8,7 +8,7 @@
