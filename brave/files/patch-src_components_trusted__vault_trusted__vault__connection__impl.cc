--- src/components/trusted_vault/trusted_vault_connection_impl.cc.orig	2025-07-02 06:08:04 UTC
+++ src/components/trusted_vault/trusted_vault_connection_impl.cc
