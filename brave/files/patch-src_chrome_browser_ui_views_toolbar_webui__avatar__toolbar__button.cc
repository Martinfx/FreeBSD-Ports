--- src/chrome/browser/ui/views/toolbar/webui_avatar_toolbar_button.cc.orig	2026-08-12 09:02:10 UTC
+++ src/chrome/browser/ui/views/toolbar/webui_avatar_toolbar_button.cc
