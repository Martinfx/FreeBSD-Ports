--- src/components/regional_capabilities/regional_capabilities_service.cc.orig	2026-07-01 06:24:19 UTC
+++ src/components/regional_capabilities/regional_capabilities_service.cc
