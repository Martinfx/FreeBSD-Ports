--- src/content/browser/shape_detection/shape_detection_service.cc.orig	2025-12-05 10:12:50 UTC
+++ src/content/browser/shape_detection/shape_detection_service.cc
@@ -15,7 +15,7 @@
 #endif
