--- src/chrome/browser/ui/views/frame/browser_frame_view_linux.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/browser/ui/views/frame/browser_frame_view_linux.cc
