--- src/third_party/blink/renderer/controller/blink_initializer.cc.orig	2026-08-31 10:59:09 UTC
+++ src/third_party/blink/renderer/controller/blink_initializer.cc
@@ -87,12 +87,12 @@
