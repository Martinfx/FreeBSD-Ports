--- src/content/browser/font_access/font_enumeration_data_source.cc.orig	2023-11-03 10:09:45 UTC
+++ src/content/browser/font_access/font_enumeration_data_source.cc
@@ -16,7 +16,7 @@
