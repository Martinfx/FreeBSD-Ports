--- src/components/webauthn/core/browser/gpm_user_verification_policy.cc.orig	2026-01-14 08:33:23 UTC
+++ src/components/webauthn/core/browser/gpm_user_verification_policy.cc
