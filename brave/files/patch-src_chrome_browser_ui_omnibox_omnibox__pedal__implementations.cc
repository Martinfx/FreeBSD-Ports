--- src/chrome/browser/ui/omnibox/omnibox_pedal_implementations.cc.orig	2026-07-01 06:24:19 UTC
+++ src/chrome/browser/ui/omnibox/omnibox_pedal_implementations.cc
