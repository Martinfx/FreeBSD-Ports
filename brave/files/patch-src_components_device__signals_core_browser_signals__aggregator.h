--- src/components/device_signals/core/browser/signals_aggregator.h.orig	2023-07-16 15:47:57 UTC
+++ src/components/device_signals/core/browser/signals_aggregator.h
