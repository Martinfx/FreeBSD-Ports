--- src/chrome/browser/ui/views/profiles/first_run_flow_controller.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/browser/ui/views/profiles/first_run_flow_controller.cc
@@ -86,7 +86,7 @@
