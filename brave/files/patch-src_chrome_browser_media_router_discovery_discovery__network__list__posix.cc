--- src/chrome/browser/media/router/discovery/discovery_network_list_posix.cc.orig	2026-04-09 06:05:42 UTC
+++ src/chrome/browser/media/router/discovery/discovery_network_list_posix.cc
@@ -5,11 +5,12 @@
