--- src/chrome/browser/enterprise/remote_commands/cbcm_remote_commands_factory.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/browser/enterprise/remote_commands/cbcm_remote_commands_factory.cc
@@ -12,7 +12,7 @@
