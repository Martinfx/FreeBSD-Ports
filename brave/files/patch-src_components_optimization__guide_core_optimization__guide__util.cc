--- src/components/optimization_guide/core/optimization_guide_util.cc.orig	2026-08-31 10:59:09 UTC
+++ src/components/optimization_guide/core/optimization_guide_util.cc
