--- src/gpu/command_buffer/service/shared_image/shared_image_factory.cc.orig	2026-08-31 10:59:09 UTC
+++ src/gpu/command_buffer/service/shared_image/shared_image_factory.cc
@@ -56,7 +56,7 @@
