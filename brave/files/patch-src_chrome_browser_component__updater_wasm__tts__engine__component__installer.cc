--- src/chrome/browser/component_updater/wasm_tts_engine_component_installer.cc.orig	2026-03-13 06:02:14 UTC
+++ src/chrome/browser/component_updater/wasm_tts_engine_component_installer.cc
@@ -14,7 +14,7 @@
