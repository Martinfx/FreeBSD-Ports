--- src/gpu/command_buffer/service/shared_image/dawn_ozone_image_representation.cc.orig	2026-08-31 10:59:09 UTC
+++ src/gpu/command_buffer/service/shared_image/dawn_ozone_image_representation.cc
