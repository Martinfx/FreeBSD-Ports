--- src/chrome/browser/ui/webui/infobar_internals/infobar_internals_handler.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/browser/ui/webui/infobar_internals/infobar_internals_handler.cc
@@ -67,7 +67,7 @@
