--- src/content/utility/on_device_model/on_device_model_sandbox_init.cc.orig	2026-03-13 06:02:14 UTC
+++ src/content/utility/on_device_model/on_device_model_sandbox_init.cc
@@ -18,16 +18,20 @@
