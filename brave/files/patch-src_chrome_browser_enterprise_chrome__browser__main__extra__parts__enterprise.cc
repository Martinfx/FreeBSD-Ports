--- src/chrome/browser/enterprise/chrome_browser_main_extra_parts_enterprise.cc.orig	2026-06-04 10:12:25 UTC
+++ src/chrome/browser/enterprise/chrome_browser_main_extra_parts_enterprise.cc
@@ -8,7 +8,7 @@
