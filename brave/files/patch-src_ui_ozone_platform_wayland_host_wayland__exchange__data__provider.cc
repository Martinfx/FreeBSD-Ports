--- src/ui/ozone/platform/wayland/host/wayland_exchange_data_provider.cc.orig	2026-07-01 06:24:19 UTC
+++ src/ui/ozone/platform/wayland/host/wayland_exchange_data_provider.cc
