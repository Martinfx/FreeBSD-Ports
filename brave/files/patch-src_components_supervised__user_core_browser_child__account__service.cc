--- src/components/supervised_user/core/browser/child_account_service.cc.orig	2026-08-31 10:59:09 UTC
+++ src/components/supervised_user/core/browser/child_account_service.cc
