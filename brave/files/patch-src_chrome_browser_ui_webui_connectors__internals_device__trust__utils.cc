--- src/chrome/browser/ui/webui/connectors_internals/device_trust_utils.cc.orig	2026-04-09 06:05:42 UTC
+++ src/chrome/browser/ui/webui/connectors_internals/device_trust_utils.cc
@@ -9,7 +9,7 @@
