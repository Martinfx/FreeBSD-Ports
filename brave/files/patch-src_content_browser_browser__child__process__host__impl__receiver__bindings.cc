--- src/content/browser/browser_child_process_host_impl_receiver_bindings.cc.orig	2026-08-12 09:02:10 UTC
+++ src/content/browser/browser_child_process_host_impl_receiver_bindings.cc
@@ -38,7 +38,7 @@
