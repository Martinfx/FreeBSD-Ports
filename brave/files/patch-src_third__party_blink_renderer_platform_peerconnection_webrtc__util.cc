--- src/third_party/blink/renderer/platform/peerconnection/webrtc_util.cc.orig	2026-03-13 06:02:14 UTC
+++ src/third_party/blink/renderer/platform/peerconnection/webrtc_util.cc
@@ -23,7 +23,7 @@
 namespace blink {
