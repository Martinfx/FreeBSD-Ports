--- src/media/capture/video/video_capture_buffer_tracker_factory_impl.cc.orig	2026-02-11 09:05:39 UTC
+++ src/media/capture/video/video_capture_buffer_tracker_factory_impl.cc
@@ -14,7 +14,7 @@
