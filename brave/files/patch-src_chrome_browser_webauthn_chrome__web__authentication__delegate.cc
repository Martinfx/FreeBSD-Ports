--- src/chrome/browser/webauthn/chrome_web_authentication_delegate.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/browser/webauthn/chrome_web_authentication_delegate.cc
@@ -69,7 +69,7 @@
