--- src/chrome/browser/ui/webui/password_manager/notification_cards/relaunch_chrome_banner.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/browser/ui/webui/password_manager/notification_cards/relaunch_chrome_banner.cc
