--- src/chrome/browser/ui/autofill/payments/desktop_payments_window_manager.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/browser/ui/autofill/payments/desktop_payments_window_manager.cc
@@ -31,7 +31,7 @@
