--- src/components/named_mojo_ipc_server/named_mojo_server_endpoint_connector_linux.cc.orig	2026-03-13 06:02:14 UTC
+++ src/components/named_mojo_ipc_server/named_mojo_server_endpoint_connector_linux.cc
@@ -8,6 +8,10 @@
 #include <sys/stat.h>
 #include <sys/types.h>
