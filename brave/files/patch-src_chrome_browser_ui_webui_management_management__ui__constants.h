--- src/chrome/browser/ui/webui/management/management_ui_constants.h.orig	2026-05-07 17:02:56 UTC
+++ src/chrome/browser/ui/webui/management/management_ui_constants.h
@@ -9,14 +9,14 @@
