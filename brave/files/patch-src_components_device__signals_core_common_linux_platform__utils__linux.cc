--- src/components/device_signals/core/common/linux/platform_utils_linux.cc.orig	2025-10-02 04:28:32 UTC
+++ src/components/device_signals/core/common/linux/platform_utils_linux.cc
@@ -4,12 +4,23 @@
