--- src/chrome/browser/ui/views/user_education/browser_user_education_service.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/browser/ui/views/user_education/browser_user_education_service.cc
