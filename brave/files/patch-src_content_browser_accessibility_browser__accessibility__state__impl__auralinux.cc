--- src/content/browser/accessibility/browser_accessibility_state_impl_auralinux.cc.orig	2026-08-31 10:59:09 UTC
+++ src/content/browser/accessibility/browser_accessibility_state_impl_auralinux.cc
@@ -14,6 +14,7 @@
 #include <sstream>
 #include <string>
