--- src/chrome/browser/ui/webui/management/management_ui_handler.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/browser/ui/webui/management/management_ui_handler.cc
@@ -76,7 +76,7 @@
