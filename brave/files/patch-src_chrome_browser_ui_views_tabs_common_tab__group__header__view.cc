--- src/chrome/browser/ui/views/tabs/common/tab_group_header_view.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/browser/ui/views/tabs/common/tab_group_header_view.cc
