--- src/chrome/browser/ui/webui/search_engine_choice/search_engine_choice_ui.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/browser/ui/webui/search_engine_choice/search_engine_choice_ui.cc
