--- src/third_party/perfetto/src/trace_processor/importers/ftrace/v4l2_tracker.cc.orig	2026-01-14 08:33:23 UTC
+++ src/third_party/perfetto/src/trace_processor/importers/ftrace/v4l2_tracker.cc
