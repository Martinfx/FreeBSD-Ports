--- src/chrome/browser/ui/webui/cr_components/searchbox/searchbox_handler.cc.orig	2026-08-31 10:59:09 UTC
+++ src/chrome/browser/ui/webui/cr_components/searchbox/searchbox_handler.cc
