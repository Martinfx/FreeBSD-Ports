--- src/ui/ozone/platform/headless/vulkan_implementation_headless.cc.orig	2025-08-07 06:57:29 UTC
+++ src/ui/ozone/platform/headless/vulkan_implementation_headless.cc
