--- src/media/capture/video/linux/video_capture_device_factory_v4l2.cc.orig	2026-07-01 06:24:19 UTC
+++ src/media/capture/video/linux/video_capture_device_factory_v4l2.cc
