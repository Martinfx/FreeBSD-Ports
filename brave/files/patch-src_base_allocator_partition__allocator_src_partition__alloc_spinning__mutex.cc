--- src/base/allocator/partition_allocator/src/partition_alloc/spinning_mutex.cc.orig	2026-07-01 06:24:19 UTC
+++ src/base/allocator/partition_allocator/src/partition_alloc/spinning_mutex.cc
@@ -20,7 +20,16 @@
 #endif
