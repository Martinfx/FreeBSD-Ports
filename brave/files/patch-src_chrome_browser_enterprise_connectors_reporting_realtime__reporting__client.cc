--- src/chrome/browser/enterprise/connectors/reporting/realtime_reporting_client.cc.orig	2026-07-01 06:24:19 UTC
+++ src/chrome/browser/enterprise/connectors/reporting/realtime_reporting_client.cc
@@ -53,7 +53,7 @@
