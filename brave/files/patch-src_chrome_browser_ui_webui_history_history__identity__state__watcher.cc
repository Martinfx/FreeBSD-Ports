--- src/chrome/browser/ui/webui/history/history_identity_state_watcher.cc.orig	2026-05-07 17:02:56 UTC
+++ src/chrome/browser/ui/webui/history/history_identity_state_watcher.cc
