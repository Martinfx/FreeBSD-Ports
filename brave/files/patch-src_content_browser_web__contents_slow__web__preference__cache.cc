--- src/content/browser/web_contents/slow_web_preference_cache.cc.orig	2025-02-19 07:43:18 UTC
+++ src/content/browser/web_contents/slow_web_preference_cache.cc
@@ -17,7 +17,7 @@
