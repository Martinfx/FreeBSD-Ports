--- src/chrome/browser/metrics/power/process_metrics_recorder_util.cc.orig	2026-04-09 06:05:42 UTC
+++ src/chrome/browser/metrics/power/process_metrics_recorder_util.cc
