--- bin/__private/_gaffer.py.orig	2026-09-24 19:41:12 UTC
...
@@ -109,6 +109,28 @@ if sys.platform in ( "linux", "darwin" )
...
+
+	appendToPath( "%%LOCALBASE%%/share/cortex/glsl", "IECOREGL_SHADER_PATHS" )
+	appendToPath( "%%LOCALBASE%%/share/cortex/glsl", "IECOREGL_SHADER_INCLUDE_PATHS" )
...
@@ -375,6 +397,8 @@ setUp3rdPartyExtensions()
