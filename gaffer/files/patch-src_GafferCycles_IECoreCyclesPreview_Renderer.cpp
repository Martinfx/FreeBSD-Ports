...
@@ -1538,7 +1538,8 @@ class InstanceCache : public IECore::RefCounted
...
@@ -1555,7 +1556,7 @@ class InstanceCache : public IECore::RefCounted
...
+				if( it.use_count() == 1 )
 				{
 					// Only one reference - this is ours, so
 					// nothing outside of the cache is using the
@@ -1757,7 +1758,7 @@ class LightCache : public IECore::RefCounted
