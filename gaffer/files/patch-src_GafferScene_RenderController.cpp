--- src/GafferScene/RenderController.cpp.orig	2025-10-29 20:36:37 UTC
...
@@ -1131,150 +1131,132 @@ class RenderController::SceneGraph
 };
...
+                tg.run([=]() {
+                    SceneGraphUpdateTask task{ m_controller, child.get(), m_sceneGraphType,
+                                              m_changedGlobalComponents, m_threadState, childPath,
+                                              m_callback, m_pathsToUpdate };
+                });
+            }
