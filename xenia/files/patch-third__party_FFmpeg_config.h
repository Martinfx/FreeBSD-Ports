--- third_party/FFmpeg/config.h.orig	2025-03-06 12:59:51 UTC
...
+#define FFMPEG_CONFIGURATION "--prefix=/usr/local/ --pkgconfigdir=/usr/local/libdata/pkgconfig"
+#define FFMPEG_LICENSE "LGPL version 2.1 or later"
+#define CONFIG_THIS_YEAR 2021
+#define FFMPEG_DATADIR "/usr/local//share/ffmpeg"
+#define AVCONV_DATADIR "/usr/local//share/ffmpeg"
+#define CC_IDENT "gcc 13.3.0 (FreeBSD Ports Collection)"
